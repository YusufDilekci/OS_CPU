...
int main(int argc, char * argv[]) {
    ...
    void processyazdir(int i) {
        ...
        if (islemler[i].oncelik == 0) {
            ...
            cpu1Ram=cpu1Ram-islemler[i].ramKullanimi;    //here basically make this 512-ramusage
            printf("Cpu1 current Ram capacity %d \n",cpu1Ram);  //print the current ram1 resources
            
            if(cpu1Ram<0)
            {
             printf("Your Cpu1Ram resources are not sufficient");  //if ram1 < 0 then throw exception
             return 0;
            };
            ...
            printf("After proceesing current Ram1 capacity %d \n",cpu1Ram); //after processing we add ram usage to ram1. which will be 512 again
            ...
            if(cpu2Ram<0)
            {
             printf("Your Cpu2Ram resources are not sufficienth");
             return 0;
            };
